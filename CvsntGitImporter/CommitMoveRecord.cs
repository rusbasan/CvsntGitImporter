...
class CommitMoveRecord
{
    ...
    private readonly OneToManyDictionary<Commit, FileInfo> m_files =
        ...
        using (m_log.Indent())
        {
            ...
            for (int i = commits.Count - 1; i >= 0; i--)
            {
                ...
                if (location < 0)
                {
                    ...
                    m_log.WriteLine("Skip moving {0} after {1}", commitToMove.ConciseFormat,
                        m_finalCommit.ConciseFormat);
                    continue;
                }
