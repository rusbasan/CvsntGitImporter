...
{
    [SwitchDef(ShortSwitch = "-C", LongSwitch = "--config", ValueDescription = "filename",
        Description = "Specify a configuration file containing parameters")]
    ...
    [SwitchDef(LongSwitch = "--noimport", ShortSwitch = "-n",
        Description = "Don't actually import the data, just do the analysis")]
    public bool NoImport { get; set; }

    [SwitchDef(LongSwitch = "--gitdir", ValueDescription = "dir",
        Description = "The directory to create the git repository in. Must not exist or be empty")]
    public string GitDir { get; set; }

    [SwitchDef(LongSwitch = "--git-config-set", ValueDescription = "name=value",
        Description = "Sets a git option in the repository. The argument is in the form name=value")]
    public ObservableCollection<string> GitConfigSet { get; set; }

    [SwitchDef(LongSwitch = "--git-config-add", ValueDescription = "name=value",
        Description = "Adds a git option in the repository. The argument is in the form name=value")]
    ...
    [SwitchDef(LongSwitch = "--cvs-processes",
        Description =
            "The number of CVS processes to run in parallel when importing. Defaults to the number of processors on the system")]
    public uint? CvsProcesses { get; set; }

    [SwitchDef(LongSwitch = "--continue-on-error",
        Description = "Report branch and tag errors but continue processing")]
    public bool ContinueOnError { get; set; }

    [SwitchDef(LongSwitch = "--no-commit-reordering",
        Description = "Turns off reordering of commits to try to match tags and branches")]
    public bool NoCommitReordering { get; set; }

    [SwitchDef(LongSwitch = "--remove-advertising",
        Description =
    ...
    [SwitchDef(LongSwitch = "--partial-tag-threshold",
        Description =
            "The number of untagged files encountered before a tag is declared to be a partial tag. Set to zero to disable partial tag detection")]
    ...
    [SwitchDef(LongSwitch = "--include", ValueDescription = "regex",
        Description = "A pattern to match files to include")]
    public ObservableCollection<string> IncludeFile { get; set; }

    [SwitchDef(LongSwitch = "--exclude", ValueDescription = "regex",
        Description = "A pattern to match files to exclude")]
    public ObservableCollection<string> ExcludeFile { get; set; }

    [SwitchDef(LongSwitch = "--head-only", ValueDescription = "regex",
        Description =
            "A pattern to match files that should have just their head version imported and no historical versions")]
    ...
    [SwitchDef(LongSwitch = "--exclude-tag", ValueDescription = "regex",
        Description = "A pattern to match tags that should not be imported")]
    public ObservableCollection<string> ExcludeTag { get; set; }

    [SwitchDef(LongSwitch = "--include-branch", ValueDescription = "regex",
        Description = "A pattern to match branches that should be imported")]
    public ObservableCollection<string> IncludeBranch { get; set; }

    [SwitchDef(LongSwitch = "--exclude-branch", ValueDescription = "regex",
        Description = "A pattern to match branches that should not be imported")]
    public ObservableCollection<string> ExcludeBranch { get; set; }

    [SwitchDef(LongSwitch = "--rename-tag", ValueDescription = "rule",
        Description = "A rule to rename tags as they're imported")]
    public ObservableCollection<string> RenameTag { get; set; }

    [SwitchDef(LongSwitch = "--rename-branch", ValueDescription = "rule",
        Description = "to rename branches as they're imported")]
